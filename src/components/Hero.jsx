...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="flex flex-col xl:flex-row justify-center min-h-screen w-full p-2 gap-10
        max-container"
    >
      <div
        className="max-xl:padding-x relative xl:w-2/5 flex flex-col justify-center items-start
          w-full pt-28"
      >
